...
class NewsItem(Base):
    ...
    story_key: Mapped[str] = mapped_column(String(64), index=True)
    ...
    publication_lag_sec: Mapped[float | None] = mapped_column(Float, nullable=True, index=True)
    ...
    __table_args__ = (
        ...
        Index("ix_news_items_story_detected", "story_key", "detected_at"),
    )
